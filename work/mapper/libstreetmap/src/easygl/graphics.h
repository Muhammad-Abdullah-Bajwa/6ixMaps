...
constexpr double DEG_TO_RAD1 = 0.017453292519943295769236907684886;
...
void set_foreground_screen();
void screen_to_foreground();
void close_tab();
void open_tab();
...
extern bool shouldFind;
extern std::vector<value> found_street_segments;
extern std::vector<unsigned> saved_intersections;
extern std::vector<unsigned> saved_POI;
 ...
 * UTF-8 string msg. 
 */
void update_message(const std::string& msg, int topBox = 0);
...
void drawtext(float xc, float yc, const std::string& text, float boundx=FLT_MAX, float boundy=FLT_MAX, bool check_fit=false, double value=0,int lower_font_bound = 6);
void drawtext(const t_point& text_center, const std::string& text, float boundx=FLT_MAX, float boundy=FLT_MAX,  bool check_fit=false, double value=0);
void drawtext(const t_point& text_center, const std::string& text, const t_bound_box& bounds, bool check_fit=false, double value=0);
void drawtext(
        const t_point& text_center, const std::string& text, const t_bound_box& bounds, float tolerance, bool check_fit=false, double value=0);

void drawtext_in(const t_bound_box& bbox, const std::string& text, bool check_fit=false, double value=0);
void drawtext_in(const t_bound_box& bbox, const std::string& text, float tolerance, bool check_fit=false, double value=0);
 ...
 */
void draw_message(int topBox = 0);
